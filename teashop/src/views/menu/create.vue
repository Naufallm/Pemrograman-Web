                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="storeMenu()">
                            ...
                            <button type="submit" class="custom-btn">
                                <span class="btn-text">Save Menu</span>
